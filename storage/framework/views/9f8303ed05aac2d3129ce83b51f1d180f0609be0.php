          ...
          <div class="mdl-grid demo-content">
            ...
            <input type="hidden" name="phd-incorporarBien" value="SI" id="phd-incorporarBien">
                    ...
                    <ul for="phd-tipo_bien" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
    					...
    					<li class="mdl-menu__item"  v-on:click="bien.tipo_bien = 'Mueble';showForm('phd-formMueble');"> <?php echo e($tipo_bien1->tipo_bien); ?> </li>
    					<?php else: ?>
    					<li class="mdl-menu__item"  v-on:click="bien.tipo_bien = 'Inmueble';showForm('phd-formInmueble');"> <?php echo e($tipo_bien1->tipo_bien); ?> </li>
    					<?php endif; ?>
                    ...
                    <div class="phd-input-group">
                      <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height getmdl-select__fullwidth">
                        ...
                        <ul for="phd-forma_adqusicion" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
                            <?php $__currentLoopData = $forma_adquisicion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $forma_adquisicion1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        	<?php if($forma_adquisicion1->forma_adquisicion=='Adjudicación'): ?>
                            <li class="mdl-menu__item"  v-on:click="showForm('phd-fa_adjudicacion',<?php echo e($forma_adquisicion1->id); ?>);bien.forma_adquisicion = 'Adjudicación'">  <?php echo e($forma_adquisicion1->forma_adquisicion); ?></li>
                            <?php endif; ?>
                            <?php if($forma_adquisicion1->forma_adquisicion=='Compra concurso abierto'): ?>
                            <li class="mdl-menu__item" v-on:click="showForm('phd-fa_compra_concurso_abierto');bien.forma_adquisicion = 'Compra concurso abierto'"><?php echo e($forma_adquisicion1->forma_adquisicion); ?></li>
                            <?php endif; ?>
                            <?php if($forma_adquisicion1->forma_adquisicion=='Compra concurso cerrado'): ?>
                            <li class="mdl-menu__item" v-on:click="showForm('phd-fa_compra_concurso_cerrado');bien.forma_adquisicion = 'Compra concurso cerrado'"><?php echo e($forma_adquisicion1->forma_adquisicion); ?></li>
                            <?php endif; ?>
                            <?php if($forma_adquisicion1->forma_adquisicion=='Compra directa'): ?>
                            <li class="mdl-menu__item" v-on:click="showForm('phd-fa_compra_directa');bien.forma_adquisicion = 'Compra directa'"><?php echo e($forma_adquisicion1->forma_adquisicion); ?></li>
                            <?php endif; ?>
                            <?php if($forma_adquisicion1->forma_adquisicion=='Confiscación'): ?>
                            <li class="mdl-menu__item" v-on:click="showForm('phd-fa_confiscacion');bien.forma_adquisicion = 'Confiscación'"><?php echo e($forma_adquisicion1->forma_adquisicion); ?></li>
                            <?php endif; ?>
                            <?php if($forma_adquisicion1->forma_adquisicion=='Dación de pago'): ?>
                            <li class="mdl-menu__item" v-on:click="showForm('phd-fa_dacion_pago');bien.forma_adquisicion = 'Dación de pago'"><?php echo e($forma_adquisicion1->forma_adquisicion); ?></li>
                            <?php endif; ?>
                            <?php if($forma_adquisicion1->forma_adquisicion=='Donación'): ?>
                            <li class="mdl-menu__item" v-on:click="showForm('phd-fa_donacion');bien.forma_adquisicion = 'Donación'"><?php echo e($forma_adquisicion1->forma_adquisicion); ?></li>
                            <?php endif; ?>
                            <?php if($forma_adquisicion1->forma_adquisicion=='Expropiación'): ?>
                            <li class="mdl-menu__item" v-on:click="showForm('phd-fa_expropiacion');bien.forma_adquisicion = 'Expropiación'"><?php echo e($forma_adquisicion1->forma_adquisicion); ?></li>
                            <?php endif; ?>
                            <?php if($forma_adquisicion1->forma_adquisicion=='Permuta'): ?>
                            <li class="mdl-menu__item" v-on:click="showForm('phd-fa_permuta');bien.forma_adquisicion = 'Permuta'"><?php echo e($forma_adquisicion1->forma_adquisicion); ?></li>
                            <?php endif; ?>
                            <?php if($forma_adquisicion1->forma_adquisicion=='Transferencia'): ?>
                            <li class="mdl-menu__item" v-on:click="showForm('phd-fa_transferencia');bien.forma_adquisicion = 'Transferencia'"><?php echo e($forma_adquisicion1->forma_adquisicion); ?></li>
                            <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                      </div>
                    ...
                    <div class="phd-input-group">
                      <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fullwidth">
                        ...
                        <ul for="phd-categoria" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
                        	<?php $__currentLoopData = $categoria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="mdl-menu__item"  v-on:click='enviarIdCategoria("<?php echo e($categoria1->id); ?>"); bien.categoria ="<?php echo e($categoria1->categoria); ?>"'><?php echo e($categoria1->categoria); ?> </li>
                      ...
                      <div  class="phd-fa_compra_directa phdHide">
                        ...
                        <div class="phd-input-group">
                          ...
                          <div id="phd-proveedorSelect" class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fullwidth">
                              ...
                              <?php $__currentLoopData = $proveedor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proveedor1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <li class="mdl-menu__item"  v-on:click="bien.fa_compra_directa.proveedor = '<?php echo e($proveedor1->descripcion); ?>'"><?php echo e($proveedor1->descripcion); ?></li>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>   
                              </ul>
                          </div>
                        </div>
                  ...
                  <div class="mdl-card__actions phdHide">
                    ...
                    <div class="phd-input-group">
                      ...
                      <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fullwidth">
                          ...
                          <?php $__currentLoopData = $estado_bien; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estado_bien1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <li class="mdl-menu__item"  v-on:click="bien.estado = '<?php echo e($estado_bien1->estado); ?>';"><?php echo e($estado_bien1->estado); ?></li>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </ul>
                      ...
                      <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fullwidth">
                          ...
                          <?php $__currentLoopData = $estado_uso; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estado_uso1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <li class="mdl-menu__item"  v-on:click="bien.estado_uso = '<?php echo e($estado_uso1->estado_uso); ?>';"><?php echo e($estado_uso1->estado_uso); ?></li>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </ul>
                      </div>
                      <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fullwidth">
                          ...
                          <?php $__currentLoopData = $uso_actual; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uso_actual1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <li class="mdl-menu__item"  v-on:click="bien.uso_actual = '<?php echo e($uso_actual1->uso_actual); ?>';"><?php echo e($uso_actual1->uso_actual); ?></li>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </ul>
                      </div>
                    </div>
                    <div class="phd-input-group">
                      ...
                      <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fullwidth">
                          ...
                          <ul for="phd-moneda" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
                            <?php $__currentLoopData = $moneda; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $moneda1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <li class="mdl-menu__item"  v-on:click="bien.moneda = '<?php echo e($moneda1->moneda); ?>';"><?php echo e($moneda1->moneda); ?></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </ul>
                      </div>
                      ...
                      <div class="phd-input-group">
                        ...
                        <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fullwidth">
                            ...
                            <ul for="phd-datos_particulares_mueble_marca" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
                             <?php $__currentLoopData = $marca; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $marca1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="mdl-menu__item"  v-on:click="bien.datos_particulares_mueble.marca = '<?php echo e($marca1->marca); ?>';"><?php echo e($marca1->marca); ?></li>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                        <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fullwidth">
                            ...
                            <?php $__currentLoopData = $modelo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modelo1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="mdl-menu__item"  v-on:click="bien.datos_particulares_mueble.modelo = '<?php echo e($modelo1->modelo); ?>';"><?php echo e($modelo1->modelo); ?></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                      </div>
                      ...
                      <div class="phd-input-group">
                        ...
                        <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fullwidth">
                            ...
                            <ul for="phd-datos_particulares_mueble_color" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
                              <?php $__currentLoopData = $color; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="mdl-menu__item"  v-on:click="bien.datos_particulares_mueble.color = '<?php echo e($color1->color); ?>';"><?php echo e($color1->color); ?></li>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                    ...
                    <div class="phd-formInmueble phdHide">
                      ...
                      <div class="phd-input-group">
                        ...
                        <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fullwidth">
                            ...
                            <?php $__currentLoopData = $unidad; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unidad2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="mdl-menu__item"  v-on:click="bien.datos_particulares_inmueble.unidad_medida_area_construccion = '<?php echo e($unidad2->unidad); ?>';"><?php echo e($unidad2->unidad); ?> </li>
                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                      </div>
                      ...
                      <div class="phd-input-group">
                        ...
                        <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fullwidth">
                            ...
                            <?php $__currentLoopData = $unidad; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unidad1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="mdl-menu__item"  v-on:click="bien.datos_particulares_inmueble.unidad_medida_area_terreno = '<?php echo e($unidad1->unidad); ?>';"><?php echo e($unidad1->unidad); ?>  <?php echo e($unidad1->simbolo); ?> </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                      </div>
                  ...
                  <div class="mdl-card__actions phdHide">
                      ...
                      <div class="phd-input-group">
                        <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fullwidth">
                            ...
                            <?php $__currentLoopData = $compañia_aseguradora; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $compañia_aseguradora1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="mdl-menu__item"  v-on:click="bien.datos_seguro.nombre_compania = '<?php echo e($compañia_aseguradora1->nombre); ?>'"><?php echo e($compañia_aseguradora1->nombre); ?></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                      ...
                      <div class="phd-input-group">
                        <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fullwidth">
                            ...
                            <?php $__currentLoopData = $cobertura; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cobertura1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="mdl-menu__item"  v-on:click="bien.datos_seguro.cobertura = '<?php echo e($cobertura1->cobertura); ?>'"><?php echo e($cobertura1->cobertura); ?></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
