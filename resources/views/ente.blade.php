 				...
 				<div class="mdl-card__actions phdHide">
                     ...
                     <div class="phd-input-group">
                        <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                          <input class="mdl-textfield__input" type="text" id="phd-codigo_rgbp" @focus="setIsFocused" onblur="removeIsFocusedImpl(this)"  name="phd-codigo_rgbp">
                          <label class="mdl-textfield__label" for="phd-id_proveedor">Código RGBP (*)</label>
                        </div>

                         <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                          <input class="mdl-textfield__input" type="text" id="phd-codigo_sigecof" @focus="setIsFocused" onblur="removeIsFocusedImpl(this)"  name="phd-codigo_sigecof">
                          <label class="mdl-textfield__label" for="phd-id_proveedor">Código SIGECOF (*)</label>
                        </div>
                        <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                          <input class="mdl-textfield__input" type="text" id="phd-siglas" @focus="setIsFocused" onblur="removeIsFocusedImpl(this)"  name="phd-siglas">
                     ...
                     <div class="phd-input-group">
                      <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                          <input class="mdl-textfield__input" type="text" id="phd-rif" @focus="setIsFocused" onblur="removeIsFocusedImpl(this)"  name="phd-rif">
                          <label class="mdl-textfield__label" for="phd-id_proveedor"> R.I.F (*)</label>

                        </div>
                        <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                          <input class="mdl-textfield__input" type="text" id="phd-razon_social" @focus="setIsFocused" onblur="removeIsFocusedImpl(this)"  name="phd-razon_social">
                    ...
                    <div class="phd-input-group">
                      <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                          <input class="mdl-textfield__input" type="text" id="phd-direccion_web" @focus="setIsFocused" onblur="removeIsFocusedImpl(this)"  name="phd-direccion_web">
