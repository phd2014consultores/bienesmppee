...
@section('content')
    ...
    <main id="bienes-app" class="mdl-layout__content mdl-color--grey-100">
        <div class="mdl-grid demo-content">
            ...
            <div id="phd-title-app"><h4><strong>Tipo de Bien</strong></h4></div>

            <form method="POST" action="/tipo_bien" id="phd-form" class="phd-form">
                ...
                <div class="phd-demo-card-dashboard mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title phd-head_with_search">
                        <h5 class="phd-title-list">Listado de Tipos de Bienes</h5>
                        ...
                        <div class="phd-formMueble phdShow">
                            <table class="phd-table-dashboard mdl-data-table mdl-js-data-table mdl-shadow--2dp">
                                ...
                                @foreach($tipo_bienes as $tipo_bien)
                                    <tr v-on:click="obtenerTipoBien({{$tipo_bien}})">
                                        <td class="mdl-data-table__cell--non-numeric">{{$tipo_bien->id}}</td>
                                        <td class="mdl-data-table__cell--non-numeric">{{$tipo_bien->nombre}} </td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                ...
                <div class="phd-demo-card-dashboard mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                        <h5 class="phd-title-list">Datos del Tipo de Bien</h5>
                        <button type="button" id="phd-datos_generales" ref="phd_button_toggel" v-on:click="arrowToggle" class="mdl-button mdl-js-button mdl-button--icon mdl-button--colored">
                            <i class="material-icons">keyboard_arrow_down</i>
                        </button>
                    </div>
                    <div class="mdl-card__actions phdHide" style="height: 200px;">
                        ...
                        <div class="phd-input-group">
                            <input v-model="tipo_bien.id" type="hidden" id="phd-it_to_update" name="phd-it_to_update">
                            <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input v-model="tipo_bien.nombre"  class="mdl-textfield__input" type="text" id="phd-nombre" @focus="setIsFocused" onblur="removeIsFocusedImpl(this)"  name="phd-nombre">
                                <label class="mdl-textfield__label" for="phd-nombre">Tipo de cobertura (*)</label>
                            </div>
                ...
                <div class="phd-buttons-form">
                    ...
                    <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" v-on:click="showModal('INFORMACIÓN','¿Está seguro de incorporar el tipo de bien con los datos suministrados?', submitIncorporar);" >
                        Agregar
                    </button>
