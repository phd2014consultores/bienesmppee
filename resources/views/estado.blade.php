...
@section('content')
        ...
        <main id="bienes-app" class="mdl-layout__content mdl-color--grey-100">
          <div class="mdl-grid demo-content">
            ...
            <div id="phd-title-app"><h4><strong>Estado</strong></h4></div>

				<form method="POST" action="estado" id="phd-form" class="phd-form">
                    ...
                    <div class="phd-demo-card-dashboard mdl-card mdl-shadow--2dp">
                        <div class="mdl-card__title phd-head_with_search">
                            <h5 class="phd-title-list">Listado de Estados</h5>
                            ...
                            <div class="phd-formMueble phdShow">
                                <table class="phd-table-dashboard mdl-data-table mdl-js-data-table mdl-shadow--2dp">
                                    ...
                                    @foreach($estados as $estado)
                                        <tr v-on:click="obtenerEstado('{{$estado->id }}',{{$paises}})">
                                            <td class="mdl-data-table__cell--non-numeric">{{$estado->pais->pais}}</td>
                                            <td class="mdl-data-table__cell--non-numeric">{{$estado->codigo}} </td>
                                            <td class="mdl-data-table__cell--non-numeric">{{$estado->estado}} </td>
                  ...
                  <div class="mdl-card__title">
                    <h5 class="phd-title-list">Datos del Estado</h5>
                    <button type="button" id="phd-datos_generales" ref="phd_button_toggel" v-on:click="arrowToggle" class="mdl-button mdl-js-button mdl-button--icon mdl-button--colored">
                     <i class="material-icons">keyboard_arrow_down</i>
                    </button>
                  </div>
 				<div class="mdl-card__actions phdHide" style="height: 200px;">
                     ...
                     <div class="phd-input-group">
                         <input v-model="estado.id" type="hidden" id="phd-it_to_update" name="phd-it_to_update">
                     ...
                     <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fullwidth">
                        <input class="mdl-textfield__input" type="text" id="phd-pais" v-model="estado.pais" readonly tabIndex="-1" name="phd-pais">
                        <label for="phd-pais" class="mdl-textfield__label"> País(*)</label>
                        <ul for="phd-pais" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
                          @foreach ($paises as $pais)
                            <li class="mdl-menu__item"  v-on:click='estado.pais ="{{$pais->pais}}"'>{{$pais->pais}}</li>
                          @endforeach
                         ...
                         <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                          <input  v-model="estado.estado"  class="mdl-textfield__input" type="text" id="phd-descripcion" @focus="setIsFocused" onblur="removeIsFocusedImpl(this)"  name="phd-descripcion">
                          <label class="mdl-textfield__label" for="phd-id_proveedor">Descripción (*)</label>
                        </div>

                        <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                          <input v-model="estado.codigo"  class="mdl-textfield__input" type="text" id="phd-codigo" @focus="setIsFocused" onblur="removeIsFocusedImpl(this)"  name="phd-codigo">
