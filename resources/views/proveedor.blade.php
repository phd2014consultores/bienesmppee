 				...
 				<div class="mdl-card__actions phdHide">
                     ...
                     <div class="phd-input-group">
                        <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                          <input class="mdl-textfield__input" type="text" id="phd-id_proveedor" @focus="setIsFocused" onblur="removeIsFocusedImpl(this)"  name="phd-id_proveedor">
                          <label class="mdl-textfield__label" for="phd-id_proveedor">Codigo del Proveedor (*)</label>

                          
                        </div>
                        <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                          <input class="mdl-textfield__input" type="text" id="phd-descripcion_proveedor" @focus="setIsFocused" onblur="removeIsFocusedImpl(this)"  name="phd-descripcion_proveedor">
                          <label class="mdl-textfield__label" for="phd-id_proveedor">Descripción del Proveedor (*)</label>

                        </div>

                        <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                          <input class="mdl-textfield__input" type="text" id="phd-tipo_proveedor" @focus="setIsFocused" onblur="removeIsFocusedImpl(this)"  name="phd-tipo_proveedor">
                     ...
                     <div class="phd-input-group">
                        <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                          <input class="mdl-textfield__input" type="text" id="phd-rif_proveedor" @focus="setIsFocused" onblur="removeIsFocusedImpl(this)"  name="phd-rif_proveedor">
                    ...
                    <div class="phd-input-group">
                        <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                          <textarea class="mdl-textfield__input" type="text" id="phd-otra_descripcion_proveedor" @focus="setIsFocused" onblur="removeIsFocusedImpl(this)"  name="phd-otra_descripcion_proveedor"></textarea>
