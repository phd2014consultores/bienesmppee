...
@section('content')
    ...
    <main id="bienes-app" class="mdl-layout__content mdl-color--grey-100">
        <div class="mdl-grid demo-content">
            ...
            <div id="phd-title-app"><h4><strong>Estado del bien (condiciones físicas)</strong></h4></div>

            <form method="POST" action="/estado_bien" id="phd-form" class="phd-form">
                ...
                <div class="phd-demo-card-dashboard mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title phd-head_with_search">
                        <h5 class="phd-title-list">Listado de Estados del bien</h5>
                    ...
                    <div class="mdl-card__actions phdShow">
                        <div class="phd-formMueble phdShow">
                            <table class="phd-table-dashboard mdl-data-table mdl-js-data-table mdl-shadow--2dp">
                                ...
                                <tbody>
                                @foreach($estados_bien as $estado_bien)
                                    <tr v-on:click="obtenerEstadoBien({{$estado_bien}})">
                                        <td class="mdl-data-table__cell--non-numeric">{{$estado_bien->id}}</td>
                                        <td class="mdl-data-table__cell--non-numeric">{{$estado_bien->estado_bien}} </td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                ...
                <div class="phd-demo-card-dashboard mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                        <h5 class="phd-title-list">Datos del Estado del Bien</h5>
                        <button type="button" id="phd-datos_generales" ref="phd_button_toggel" v-on:click="arrowToggle" class="mdl-button mdl-js-button mdl-button--icon mdl-button--colored">
                            <i class="material-icons">keyboard_arrow_down</i>
                        </button>
                    </div>
                    <div class="mdl-card__actions phdHide" style="height: 200px;">
                        ...
                        <div class="phd-input-group">
                            ...
                            <div class="phd-input-out phd-is-focused mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input v-model="estado_bien.estado_bien"  class="mdl-textfield__input" type="text" id="phd-estado_bien" @focus="setIsFocused" onblur="removeIsFocusedImpl(this)"  name="phd-estado_bien">
                                <label class="mdl-textfield__label" for="phd-estado_bien">Estado del Bien (*)</label>
                            </div>
                ...
                <div class="phd-buttons-form">
                    ...
                    <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" v-on:click="showModal('INFORMACIÓN','¿Está seguro de incorporar el estado del bien con los datos suministrados?', submitIncorporar);" >
                        Agregar
                    </button>
